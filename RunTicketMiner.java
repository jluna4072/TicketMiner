...
public class RunTicketMiner implements EventManageable {
     ...
     */
    private void organizerManageEvent() {
        boolean back = false;
        while (!back) {
            System.out.println("\n===== Manage Event =====");
     ...
     */
    private void organizerAddEvent() {
        System.out.println("\n--- Add New Event ---");
        String type;
        while (true) {
     ...
     */
    private void organizerViewEvent() {
        System.out.println("\n===== View Events =====");
        ...
        if (choice.equals("a")) {
            ...
            try {
                Event found = organizerSearchEvent(query);
     ...
     */
    private void organizerUpdateEvent() {
     ...
     */
    private void organizerDeleteEvent() {
        System.out.print("\nEnter search term to find event (Event ID, Name, or Date): ");
        String query = in.nextLine().trim();
        try {
            Event found = organizerSearchEvent(query);
     ...
     */
    private Event organizerSearchEvent(String query) throws EventNotFoundException {
