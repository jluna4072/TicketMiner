...
public class Sport extends Event {
    ...
    /**
     * Constructs a Sport event with the specified scheduling and pricing details.
     *
     * @param id the unique numeric identifier for the sport event
    ...
    /**
     * Constructs a Sport event with full details including venue, capacity, and seat allocation.
     *
     ...
     */
    public Sport(int id, String type, String name, String date, String time,
