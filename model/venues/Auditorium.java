...
public class Auditorium extends Venue {
    ...
    /**
     * Constructs a default Auditorium with no initial field values.
     */
    public Auditorium() {
    }

    /**
     * Constructs an Auditorium with the specified identity, capacity, cost, and seating section percentages.
     *
     * @param id the unique numeric identifier for the auditorium
     ...
     */
    public Auditorium(int id, String name, String type, int capacity, int concertCapacity, double cost, int vipPercent, int goldPercent, int silverPercent, int bronzePercent, int generalAdmissionPercent, int reservedPercent) {
